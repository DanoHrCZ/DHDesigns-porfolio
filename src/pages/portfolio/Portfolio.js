...
const Portfolio = () => {
    ...
    <div className="animated-left">
        <h1>projekty</h1>
        <p><a className="a" href="">Web pro kapelu Storno</a>. (Propagace kapely Storno. Obsahuje veškeré důležité informace, diskografii a informace o nadcházejících koncertech. )</p>
